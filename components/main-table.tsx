...
const companies = [
  {
    ...
    domain: "vercel.com",
    deals: [
      { name: "Vercel", avatar: "/placeholder.svg?height=16&width=16" },
      { name: "Vercel - Expansion", avatar: "/placeholder.svg?height=16&width=16" },
    ],
    icpFit: "Excellent",
  ...
  },
  {
    ...
    deals: [{ name: "DigitalOcean", avatar: "/placeholder.svg?height=16&width=16" }],
    icpFit: "Medium",
  ...
  },
  {
    ...
    logo: "/placeholder.svg?height=24&width=24",
    domain: "github.com",
    deals: [{ name: "GitHub - x20 Enterprise", avatar: "/placeholder.svg?height=16&width=16" }],
    icpFit: "Good",
  ...
  },
  {
    ...
    logo: "/placeholder.svg?height=24&width=24",
    domain: "stripe.com",
    deals: [{ name: "Stripe", avatar: "/placeholder.svg?height=16&width=16" }],
    icpFit: "Good",
    icpColor: "text-green-600 bg-green-50 dark:bg-green-950 dark:text-green-400",
    estimatedArr: "$1B-$10B",
    connectionStrength: "Very strong",
  ...
  },
  {
    ...
    logo: "/placeholder.svg?height=24&width=24",
    domain: "figma.com",
    deals: [{ name: "Figma", avatar: "/placeholder.svg?height=16&width=16" }],
    icpFit: "Good",
    icpColor: "text-green-600 bg-green-50 dark:bg-green-950 dark:text-green-400",
    estimatedArr: "$500M-$1B",
    connectionStrength: "Very strong",
