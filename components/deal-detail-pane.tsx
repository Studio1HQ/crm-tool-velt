    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            variant="outline"
            className={cn(
              "flex-1 sm:flex-none bg-transparent hover:bg-primary hover:text-primary-foreground",
              activeTab === "comments" && "bg-primary text-primary-foreground"
            )}
      ...
      <div className="flex-1 overflow-hidden">
        ...
        >
                    ...
                    {deal.deals.map((dealItem: any, index: number) => (
                      ...
                      >
                        <Avatar className="h-6 w-6">
                          <AvatarImage
                            src={dealItem.avatar || "/placeholder.svg"}
                            alt={dealItem.name}
                          />
                          <AvatarFallback className="text-xs">
                            {dealItem.name.charAt(0)}
                          </AvatarFallback>
                        </Avatar>
          ...
          <TabsContent
            value="comments"
            className="flex-1 mt-0 overflow-y-scroll px-4 py-2"
          >
